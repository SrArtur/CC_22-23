...
def get_today_prices(db_format: bool = True, simplify: bool = False):
    ...
    response = requests.get(url='https://api.esios.ree.es/indicators/1001', headers={
        'Accept': 'application/json; application/vnd.esios-api-v2+json', 'Content-Type': 'application/json',
